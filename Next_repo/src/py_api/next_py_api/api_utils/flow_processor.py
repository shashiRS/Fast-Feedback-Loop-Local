            ...
            if sim_nodes:
                for it_sim_nodes in sim_nodes:
                    for it_run in sim_run:
                        return process_run(
                            it_run, it_sim_nodes, it_run_export, it_run_input, next_execution, process_handler
                        )
            else:
                for it_run in sim_run:
                    return process_run(it_run, None, it_run_export, it_run_input, next_execution, process_handler)

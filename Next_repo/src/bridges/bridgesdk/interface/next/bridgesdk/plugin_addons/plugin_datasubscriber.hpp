...
public:
  ...
  //! Checks if a subscribed url is actually connected
  /*!
   * @param url of subscription
   * @param optional timeout definiton
   */
  virtual bool checkConnectionWait(const std::string &url_name, size_t timeout_ms = 1500) const;

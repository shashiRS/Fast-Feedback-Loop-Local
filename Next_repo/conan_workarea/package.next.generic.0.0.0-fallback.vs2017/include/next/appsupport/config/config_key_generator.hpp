...
inline std::string getSyncModeV1(const std::string &component_name, const std::string &port_name) {
  return component_name + ":in_port:" + port_name + ":sync:mode";
}
...
inline std::string getTimestampSyncrefPortMemberUrl(const std::string &component_name, const std::string &port_name) {
  return component_name + ":in_port:" + port_name + ":sync:timestamp:member_data_url";
}

inline std::string getSyncValueTimestampUrl(const std::string &component_name, const std::string &port_name) {
  return component_name + ":in_port:" + port_name + ":sync:SyncValue:timestamp_url";
}

inline std::string getSyncValueSyncIdUrl(const std::string &component_name, const std::string &port_name) {
  return component_name + ":in_port:" + port_name + ":sync:SyncValue:sync_id_url";
}

inline std::string getSyncValueSyncrefBaseControlUrl(const std::string &component_name, const std::string &port_name) {
  return component_name + ":in_port:" + port_name + ":sync:SyncValue:syncref_base_control_url";
}

inline std::string getSyncValueSyncrefSyncHeaderUrl(const std::string &component_name, const std::string &port_name) {
  return component_name + ":in_port:" + port_name + ":sync:SyncValue:syncref_sync_header_url";
}

inline std::string getAlgoModeV1(const std::string &component_name, const std::string &port_name) {
  return component_name + ":in_port:" + port_name + ":sync:algo";
}

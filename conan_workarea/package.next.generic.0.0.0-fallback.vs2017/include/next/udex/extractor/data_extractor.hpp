...
public:
  ...
  //! gets information about the maximum size of the extraction queue
  /*!
   * return the value of extraction queue max size

   * @return number of max packages that can be stored in that specific udex queue
   */
  virtual unsigned short GetExtractionQueueMaxSize();

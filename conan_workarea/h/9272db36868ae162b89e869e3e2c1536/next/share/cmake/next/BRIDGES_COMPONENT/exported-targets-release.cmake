...
# Import target "next::system_RawFrameView" for configuration "Release"
set_property(TARGET next::system_RawFrameView APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(next::system_RawFrameView PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "next::next_plugin"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/plugins/core/system_RawFrameView/system_RawFrameView.dll"
  )

list(APPEND _cmake_import_check_targets next::system_RawFrameView )
list(APPEND _cmake_import_check_files_for_next::system_RawFrameView "${_IMPORT_PREFIX}/bin/plugins/core/system_RawFrameView/system_RawFrameView.dll" )
...
# Import target "next::system_PerformanceViewer" for configuration "Release"
set_property(TARGET next::system_PerformanceViewer APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(next::system_PerformanceViewer PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "eCAL::core;next::next_plugin"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/plugins/core/system_PerformanceViewer/system_PerformanceViewer.dll"
  )

list(APPEND _cmake_import_check_targets next::system_PerformanceViewer )
list(APPEND _cmake_import_check_files_for_next::system_PerformanceViewer "${_IMPORT_PREFIX}/bin/plugins/core/system_PerformanceViewer/system_PerformanceViewer.dll" )

...
class nextPackage(ConanFile):
    ...
    # -- conan attributes
    name = "next.delivery" # we use the binary key as conan package name
    ...
    def __bricks_init(self):
        ...
        if not hasattr(self, '__cip_binary_dependencies'):
            ...
            binary_dependencies = {'vs2017': {'deploy': ['asio.generic', 'ecal.measurement', 'hdf5.generic', 'mts-core-lib', 'mts-sentinel', 'recycle.generic', 'simpleini.generic', 'spdlog.generic', 'tclap.generic', 'tcp_pubsub.generic'], 'production': ['VFR_Utilities.generic', 'asio.generic', 'cip_adaption_boost.generic', 'cmake', 'ecal.measurement', 'flatbuffers', 'hdf5.generic', 'jsoncpp.generic', 'make', 'mts-core-lib', 'mts-sentinel', 'protobuf', 'recycle.generic', 'simpleini.generic', 'spdlog.generic', 'tclap.generic', 'tcp_pubsub.generic'], 'build': ['VFR_Utilities.generic', 'bricks_cmake_checks.__system', 'bricks_cmake_core.__system', 'bricks_cmake_groups.__system', 'cip_adaption_boost.generic', 'cip_build_system_platforms.__system', 'cmake', 'flatbuffers', 'jsoncpp.generic', 'make', 'protobuf'], 'system': ['bricks_cmake_checks.__system', 'bricks_cmake_core.__system', 'bricks_cmake_groups.__system'], 'platform': 'cip_build_system_platforms.__system', 'all': ['VFR_Utilities.generic', 'asio.generic', 'bricks_cmake_checks.__system', 'bricks_cmake_core.__system', 'bricks_cmake_groups.__system', 'cip_adaption_boost.generic', 'cip_build_system_platforms.__system', 'cmake', 'ecal.measurement', 'flatbuffers', 'hdf5.generic', 'jsoncpp.generic', 'make', 'mts-core-lib', 'mts-sentinel', 'protobuf', 'recycle.generic', 'simpleini.generic', 'spdlog.generic', 'tclap.generic', 'tcp_pubsub.generic']}, 'linux64_x86_gcc_7-v2-release': {'build': ['VFR_Utilities.generic', 'bricks_cmake_checks.__system', 'bricks_cmake_core.__system', 'bricks_cmake_groups.__system', 'cip_adaption_boost.generic', 'cip_build_system_platforms.__system', 'cmake', 'flatbuffers', 'jsoncpp.generic', 'make', 'protobuf'], 'production': ['VFR_Utilities.generic', 'asio.generic', 'cip_adaption_boost.generic', 'cmake', 'ecal.measurement', 'flatbuffers', 'hdf5.generic', 'jsoncpp.generic', 'make', 'mts-core-lib', 'mts-sentinel', 'protobuf', 'recycle.generic', 'simpleini.generic', 'spdlog.generic', 'tclap.generic', 'tcp_pubsub.generic'], 'system': ['bricks_cmake_checks.__system', 'bricks_cmake_core.__system', 'bricks_cmake_groups.__system'], 'platform': 'cip_build_system_platforms.__system', 'deploy': ['asio.generic', 'ecal.measurement', 'hdf5.generic', 'mts-core-lib', 'mts-sentinel', 'recycle.generic', 'simpleini.generic', 'spdlog.generic', 'tclap.generic', 'tcp_pubsub.generic'], 'all': ['VFR_Utilities.generic', 'asio.generic', 'bricks_cmake_checks.__system', 'bricks_cmake_core.__system', 'bricks_cmake_groups.__system', 'cip_adaption_boost.generic', 'cip_build_system_platforms.__system', 'cmake', 'ecal.measurement', 'flatbuffers', 'hdf5.generic', 'jsoncpp.generic', 'make', 'mts-core-lib', 'mts-sentinel', 'protobuf', 'recycle.generic', 'simpleini.generic', 'spdlog.generic', 'tclap.generic', 'tcp_pubsub.generic']}, 'ubuntu_20_04_x86_64-release': {'deploy': ['asio.generic', 'ecal.measurement', 'hdf5.generic', 'mts-core-lib', 'mts-sentinel', 'recycle.generic', 'simpleini.generic', 'spdlog.generic', 'tclap.generic', 'tcp_pubsub.generic'], 'production': ['VFR_Utilities.generic', 'asio.generic', 'cip_adaption_boost.generic', 'cmake', 'ecal.measurement', 'flatbuffers', 'hdf5.generic', 'jsoncpp.generic', 'make', 'mts-core-lib', 'mts-sentinel', 'protobuf', 'recycle.generic', 'simpleini.generic', 'spdlog.generic', 'tclap.generic', 'tcp_pubsub.generic'], 'build': ['VFR_Utilities.generic', 'bricks_cmake_checks.__system', 'bricks_cmake_core.__system', 'bricks_cmake_groups.__system', 'cip_adaption_boost.generic', 'cip_build_system_platforms.__system', 'cmake', 'flatbuffers', 'jsoncpp.generic', 'make', 'protobuf'], 'system': ['bricks_cmake_checks.__system', 'bricks_cmake_core.__system', 'bricks_cmake_groups.__system'], 'platform': 'cip_build_system_platforms.__system', 'all': ['VFR_Utilities.generic', 'asio.generic', 'bricks_cmake_checks.__system', 'bricks_cmake_core.__system', 'bricks_cmake_groups.__system', 'cip_adaption_boost.generic', 'cip_build_system_platforms.__system', 'cmake', 'ecal.measurement', 'flatbuffers', 'hdf5.generic', 'jsoncpp.generic', 'make', 'mts-core-lib', 'mts-sentinel', 'protobuf', 'recycle.generic', 'simpleini.generic', 'spdlog.generic', 'tclap.generic', 'tcp_pubsub.generic']}}
            requirements = {'vs2017': {'build': {'protobuf': 'protobuf/3.11.4-tb8@3rdparty/releases', 'jsoncpp.generic': 'jsoncpp.generic/1.9.5-1@cip/releases', 'VFR_Utilities.generic': 'VFR_Utilities.generic/1.2.0@cip/releases', 'flatbuffers': 'flatbuffers/2.0.6-tb2@3rdparty/releases', 'cip_adaption_boost.generic': 'cip_adaption_boost.generic/1.80.0-release3@cip/releases', 'bricks_cmake_groups.__system': 'bricks_cmake_groups.__system/1.12.1@cip/releases', 'bricks_cmake_core.__system': 'bricks_cmake_core.__system/1.4.0@cip/releases', 'make': 'make/4.4.1@3rdparty/releases', 'cmake': 'cmake/3.25.0@3rdparty/releases', 'bricks_cmake_checks.__system': 'bricks_cmake_checks.__system/1.8.0@cip/releases', 'cip_build_system_platforms.__system': 'cip_build_system_platforms.__system/3.55.6@cip/releases'}, 'deploy': {'mts-core-lib': 'mts-core-lib/0.9.10@3rdparty/releases', 'spdlog.generic': 'spdlog.generic/1.12.0@cip/releases', 'ecal.measurement': 'ecal.measurement/5.13.0-rc6-c72f8b7@cip/releases', 'asio.generic': 'asio.generic/1.28.1@cip/releases', 'tcp_pubsub.generic': 'tcp_pubsub.generic/1.0.4@cip/releases', 'recycle.generic': 'recycle.generic/7.0.0@cip/releases', 'simpleini.generic': 'simpleini.generic/4.20.0@cip/releases', 'tclap.generic': 'tclap.generic/1.2.5@cip/releases', 'hdf5.generic': 'hdf5.generic/1.14.1@cip/releases', 'mts-sentinel': 'mts-sentinel/0.2.2@3rdparty/releases'}}, 'linux64_x86_gcc_7-v2-release': {'build': {'flatbuffers': 'flatbuffers/2.0.6-tb2@3rdparty/releases', 'jsoncpp.generic': 'jsoncpp.generic/1.9.5-1@cip/releases', 'protobuf': 'protobuf/3.11.4-tb8@3rdparty/releases', 'cip_adaption_boost.generic': 'cip_adaption_boost.generic/1.80.0-release3@cip/releases', 'VFR_Utilities.generic': 'VFR_Utilities.generic/1.2.0@cip/releases', 'bricks_cmake_groups.__system': 'bricks_cmake_groups.__system/1.12.1@cip/releases', 'bricks_cmake_core.__system': 'bricks_cmake_core.__system/1.4.0@cip/releases', 'make': 'make/4.4.1@3rdparty/releases', 'cmake': 'cmake/3.25.0@3rdparty/releases', 'bricks_cmake_checks.__system': 'bricks_cmake_checks.__system/1.8.0@cip/releases', 'cip_build_system_platforms.__system': 'cip_build_system_platforms.__system/3.55.6@cip/releases'}, 'deploy': {'spdlog.generic': 'spdlog.generic/1.12.0@cip/releases', 'mts-core-lib': 'mts-core-lib/0.9.10@3rdparty/releases', 'ecal.measurement': 'ecal.measurement/5.13.0-rc6-c72f8b7@cip/releases', 'tcp_pubsub.generic': 'tcp_pubsub.generic/1.0.4@cip/releases', 'asio.generic': 'asio.generic/1.28.1@cip/releases', 'recycle.generic': 'recycle.generic/7.0.0@cip/releases', 'tclap.generic': 'tclap.generic/1.2.5@cip/releases', 'simpleini.generic': 'simpleini.generic/4.20.0@cip/releases', 'hdf5.generic': 'hdf5.generic/1.14.1@cip/releases', 'mts-sentinel': 'mts-sentinel/0.2.2@3rdparty/releases'}}, 'ubuntu_20_04_x86_64-release': {'build': {'protobuf': 'protobuf/3.11.4-tb8@3rdparty/releases', 'jsoncpp.generic': 'jsoncpp.generic/1.9.5-1@cip/releases', 'flatbuffers': 'flatbuffers/2.0.6-tb2@3rdparty/releases', 'cip_adaption_boost.generic': 'cip_adaption_boost.generic/1.80.0-release3@cip/releases', 'VFR_Utilities.generic': 'VFR_Utilities.generic/1.2.0@cip/releases', 'bricks_cmake_groups.__system': 'bricks_cmake_groups.__system/1.12.1@cip/releases', 'bricks_cmake_core.__system': 'bricks_cmake_core.__system/1.4.0@cip/releases', 'make': 'make/4.4.1@3rdparty/releases', 'cmake': 'cmake/3.25.0@3rdparty/releases', 'bricks_cmake_checks.__system': 'bricks_cmake_checks.__system/1.8.0@cip/releases', 'cip_build_system_platforms.__system': 'cip_build_system_platforms.__system/3.55.6@cip/releases'}, 'deploy': {'mts-core-lib': 'mts-core-lib/0.9.10@3rdparty/releases', 'ecal.measurement': 'ecal.measurement/5.13.0-rc6-c72f8b7@cip/releases', 'hdf5.generic': 'hdf5.generic/1.14.1@cip/releases', 'recycle.generic': 'recycle.generic/7.0.0@cip/releases', 'asio.generic': 'asio.generic/1.28.1@cip/releases', 'simpleini.generic': 'simpleini.generic/4.20.0@cip/releases', 'tcp_pubsub.generic': 'tcp_pubsub.generic/1.0.4@cip/releases', 'spdlog.generic': 'spdlog.generic/1.12.0@cip/releases', 'tclap.generic': 'tclap.generic/1.2.5@cip/releases', 'mts-sentinel': 'mts-sentinel/0.2.2@3rdparty/releases'}}}
